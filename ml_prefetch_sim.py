...
Options:
    ...
    --num-instructions <num-instructions>
        ...
        {default_cloud_instrs}M instructions for the cloudsuite benchmarks.
...
'''.format(prog=sys.argv[0], default_results_dir=default_results_dir,
    default_spec_instrs=default_spec_instrs, default_cloud_instrs=default_cloud_instrs,
...
def run_command():
    ...
    parser.add_argument('--num-instructions', default=None) #default_spec_instrs if execution_trace[0].isdigit() else default_cloud_instrs)
    ...
    if args.num_instructions is None:
        args.num_instructions = default_spec_instrs if execution_trace[0].isdigit() else default_cloud_instrs
